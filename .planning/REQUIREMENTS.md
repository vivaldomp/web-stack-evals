...
- [x] **AGENT-02**: Start a session injecting prompt + skills + mockup image
- [x] **AGENT-03**: Agent builds the app in the workspace using Pi native tools (no MCP required for the v1 row)
...
- [x] **EVAL-01**: PixelMatch visual-similarity score between expected and generated screenshot
